...
public class DetectorController {
    ...
    @PostMapping(value = "/detect-clones", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Perform code clone detection against provided resources")
    public Set<CodeCloneDto> detectClones(@Valid @RequestBody CloneDetectionTaskDto dto) {
      return detectorService.detectClones(dto);
    }
}
